...
{    
     ...
     /// To Primarily bypass the de-allocations caused by implict ToString conversions of numeric primitive types.
     /// This class is not suitable for high precision and for a game it doesn't need to be, this is mostly for on the fly text output.
